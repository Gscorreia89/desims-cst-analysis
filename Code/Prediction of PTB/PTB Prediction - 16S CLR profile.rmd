...
## VMET 
# 1st Trimester
vmet16S_1Trim <- getNearestSample(vmet16S, 8, max_week_difference = 7)
ptb_vmet_1Trim <- random_forest_comparison_Outcome(subset(vmet16S_1Trim, Outcome %in% c("Term", "Preterm")), first_microbe_idx = first_microbe_idx_vmet, outcome_var = 'Outcome')
rm(vmet16S_1Trim)

# 2nd Trimester
vmet16S_2Trim <- getNearestSample(vmet16S, 20, max_week_difference = 7)
ptb_vmet_2Trim <- random_forest_comparison_Outcome(subset(vmet16S_2Trim, Outcome %in% c("Term", "Preterm")), first_microbe_idx = first_microbe_idx_vmet, outcome_var = 'Outcome')
rm(vmet16S_2Trim)

# 3rd Trimester
vmet16S_3Trim <- getNearestSample(vmet16S, 32, max_week_difference = 7)
ptb_vmet_3Trim <- random_forest_comparison_Outcome(subset(vmet16S_3Trim, Outcome %in% c("Term", "Preterm")), first_microbe_idx = first_microbe_idx_vmet, outcome_var = 'Outcome')
rm(vmet16S_3Trim)
```
...
## VMET2
# 1st Trimester
vmet216S_1Trim <- getNearestSample(vmet216S, 8,  max_week_difference = 7)
ptb_vmet2_1Trim <- random_forest_comparison_Outcome(subset(vmet216S_1Trim, Outcome %in% c("Term", "Preterm")), first_microbe_idx = first_microbe_idx_vmet2, outcome_var = 'Outcome')
rm(vmet216S_1Trim)

# 2nd Trimester
vmet216S_2Trim <- getNearestSample(vmet216S, 20,  max_week_difference = 7)
ptb_vmet2_2Trim <- random_forest_comparison_Outcome(subset(vmet216S_2Trim, Outcome %in% c("Term", "Preterm")), first_microbe_idx = first_microbe_idx_vmet2, outcome_var = 'Outcome')
rm(vmet216S_2Trim)

# 3rd Trimester
vmet216S_3Trim <- getNearestSample(vmet216S, 32,  max_week_difference = 7)
ptb_vmet2_3Trim <- random_forest_comparison_Outcome(subset(vmet216S_3Trim, Outcome %in% c("Term", "Preterm")), first_microbe_idx = first_microbe_idx_vmet2, outcome_var = 'Outcome')
rm(vmet216S_3Trim)
```
