...
## VMET2
# 1st Trimester
immune_1Trim <- getNearestSample(vmet2_immune, 7,  max_week_difference = 7)
ptb_vmet2_1Trim <- random_forest_comparison_Outcome(subset(immune_1Trim, Outcome %in% c("Term", "Preterm")), first_variable_idx = first_immune_idx_vmet2, outcome_var = 'Outcome')
rm(immune_1Trim)

# 2nd Trimester
immune_2Trim <- getNearestSample(vmet2_immune, 19,  max_week_difference = 5)
ptb_vmet2_2Trim <- random_forest_comparison_Outcome(subset(immune_2Trim, Outcome %in% c("Term", "Preterm")), first_variable_idx = first_immune_idx_vmet2, outcome_var = 'Outcome')
rm(immune_2Trim)

# 3rd Trimester
immune_3Trim <- getNearestSample(vmet2_immune, 32,  max_week_difference = 8)
ptb_vmet2_3Trim <- random_forest_comparison_Outcome(subset(immune_3Trim, Outcome %in% c("Term", "Preterm")), first_variable_idx = first_immune_idx_vmet2, outcome_var = 'Outcome')
rm(immune_3Trim)
```
