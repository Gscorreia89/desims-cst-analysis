...
# Distribution of measured and predicted immune markers at early and late gestation. (Figures 5-B and 5-C)
```{r}
# ------------------
# MBL 
...
capture.output(emtrends(lmer(MBL_OOB ~ GestationalAge*Outcome*LDominant_CST + (0 + GestationalAge|SubjectID) + (1|SubjectID), OOB_predictions_frame), pairwise~Outcome|LDominant_CST, var='GestationalAge'), file='./CVF_ImmuneMarkers_Analysis/MBL_predicted_trends.txt')
