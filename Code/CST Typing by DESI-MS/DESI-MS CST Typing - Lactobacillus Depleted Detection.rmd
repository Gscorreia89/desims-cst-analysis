...
get_roc <- function(model, levels, target) {
   ...
   # References
   # [1] Hastie, T., Tibshirani, R., & Friedman, J. (2009). The Elements of Statistical Learning. Elements, 1, 337–387. https://doi.org/10.1007/b94608
...
```
## Supplementary analysis I - Relative Abundance alternative to Hierarchical clustering CST assignment
...
## Supplementary analysis II - Comparison of the out-of-bag (OOB) and Cross-validation performance estimates.
...
## Supplementary analysis III - Comparison of results from models with gestational age as predictor
...
## Supplementary analysis IV - Comparison of results with leave subject-out CV
To in
```{r}
